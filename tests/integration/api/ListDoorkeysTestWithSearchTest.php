...
class ListDoorkeysTestWithSearchTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $this->database()->table('doorkeys')->insert([
            ['id' => 1, 'key' => 'SecretKey', 'group_id' => 3, 'max_uses' => 10, 'uses' => 0, 'activates' => 1],
            ['id' => 2, 'key' => 'SecretKey2', 'group_id' => 3, 'max_uses' => 10, 'uses' => 1, 'activates' => 1],
            ['id' => 3, 'key' => '3Secret', 'group_id' => 3, 'max_uses' => 10, 'uses' => 2, 'activates' => 0],
