...
class ShowDoorkeyTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->prepareDatabase([
            'doorkeys' => [
                ...
                ['id' => 4, 'key' => 'ABCDEFG4', 'group_id' => 1, 'max_uses' => 10, 'uses' => 3, 'activates' => 1],
                ['id' => 5, 'key' => 'ABCDEFG5', 'group_id' => 3, 'max_uses' => 20, 'uses' => 4, 'activates' => 1],
                ['id' => 6, 'key' => 'ABCDEFG6', 'group_id' => 4, 'max_uses' => 10, 'uses' => 5, 'activates' => 1],
                ['id' => 7, 'key' => 'ABCDEFG7', 'group_id' => 3, 'max_uses' => 10, 'uses' => 6, 'activates' => 1],
                ['id' => 8, 'key' => 'ABCDEFG8', 'group_id' => 3, 'max_uses' => 30, 'uses' => 7, 'activates' => 1],
                ['id' => 9, 'key' => 'ABCDEFG9', 'group_id' => 4, 'max_uses' => 10, 'uses' => 8, 'activates' => 0],
                ...
                ['id' => 12, 'key' => 'ABCDEFG12', 'group_id' => 1, 'max_uses' => 10, 'uses' => 9, 'activates' => 0],
                ...
                ['id' => 16, 'key' => 'ABCDEFG16', 'group_id' => 1, 'max_uses' => 10, 'uses' => 5, 'activates' => 0],
                ...
                ['id' => 20, 'key' => 'ABCDEFG20', 'group_id' => 4, 'max_uses' => 40, 'uses' => 1, 'activates' => 1],
     ...
     */
    public function permitted_users_can_see_doorkey($actorId)
    {
        $response = $this->send(
            $this->request('GET', '/api/fof/doorkeys/5', [
        ...
        $this->assertEquals('ABCDEFG5', Arr::get($data, 'data.attributes.key'));
    }
     ...
     */
    public function unpermitted_users_cannot_see_doorkey($actorId)
    {
        $response = $this->send(
            $this->request('GET', '/api/fof/doorkeys/5', [
                'authenticatedAs' => $actorId,
    ...
    public function group_relationship_included_by_default()
    {
        ...
        $this->assertEquals(1, count(Arr::get($data, 'included', [])));
    }
}
